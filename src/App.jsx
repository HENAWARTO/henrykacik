...
const PROJECTS = [
 {
  ...
  { 
    ...
    role: "Lighting Designer", 
    year: "2023", 
    hero: pub("evvys/evvy1.jpg"), 
    blurb: "Live broadcast polish and musical variety. Update later.", 
    photos: ["/images/evvys-1.jpg","/images/evvys-2.jpg"], 
    captions: ["Hero image","Musical number"], 
    credits: ["Executive Producer: Name","Director: Name","Scenic Design: Name","Video: Name","Audio: Name","Stage Manager: Name"] },
